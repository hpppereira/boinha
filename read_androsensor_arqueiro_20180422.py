...
pathname = os.environ['HOME'] + '/GoogleDrive/boinha/data/Arqueiro_20180422/'

cel = 'Cel_Manolo_20180422_171100_AndroSensor.csv'
tab = 'Tablet_Henrique_20180422_175121_AndroSensor.csv'

#escolha o dado para reprocessar
dd = pd.read_csv(pathname + cel)


#cria coluna time com datetime (ate milesimo) - 4hz
dd['time'] = pd.to_datetime(dd.ix[:,13], format='%Y-%m-%d %H:%M:%S:%f')
